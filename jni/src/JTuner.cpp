...
JNIEXPORT jint JNICALL Java_ca_uwaterloo_jcltune_JTuner_addKernel(JNIEnv *env,
		jobject obj, jobject jfilenames, jstring jkernel_name,
...
JNIEXPORT jint JNICALL Java_ca_uwaterloo_jcltune_JTuner_addKernelFromString(
	...
	// Call function
	Tuner *t = getHandle<Tuner>(env, obj);
	size_t kernelId = t->AddKernelFromString(source, kernel_name, global,
			local);
